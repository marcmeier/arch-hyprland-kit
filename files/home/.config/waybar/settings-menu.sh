...
# colours (kept out of the sync, lib/lists.sh MACHINE_LOCAL). None of them travels with the kit.
...
action=$1
if [[ -z $action ]]; then
  choice=$(printf '%s\n' "󰕮  Waybar widgets (show, hide, move)" "󰸉  Wallpaper and colours" "󰍹  Monitors" "󰓦  Kit sync" |
