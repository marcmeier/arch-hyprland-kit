...
import html, json, os, re, socket, subprocess, sys
...
while True:
    ...
    *lines, buf = buf.split(b"\n")
    if any(l.decode(errors="replace").partition(">>")[0] in
           ("activewindowv2", "windowtitlev2", "closewindow", "openwindow", "workspacev2", "movewindowv2")
           for l in lines):
        emit()
