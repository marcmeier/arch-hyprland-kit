...
-- in ~/.config/uwsm/env, so the systemd units and apps started by uwsm get the same values
...
hl.config({
    input = {
        kb_layout  = "us", -- personal/hyprland.lua or hosts/<host>/hyprland.lua set yours
        kb_variant = "",
        kb_model   = "",
        kb_options = "",
        kb_rules   = "",
